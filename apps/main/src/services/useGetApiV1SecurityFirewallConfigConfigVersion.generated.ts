...
export const useGetApiV1SecurityFirewallConfigConfigVersionResponse = z.object({
  ownerId: z.string(),
  projectKey: z.string(),
  id: z.string(),
  version: z.number(),
...
export type UseGetApiV1SecurityFirewallConfigConfigVersionArgs = {
  projectId: string;
...
export const getApiV1SecurityFirewallConfigConfigVersionQueryOptions = (
  args: UseGetApiV1SecurityFirewallConfigConfigVersionArgs,
) =>
  queryOptions({
    queryKey: [
    ...
    queryFn: () =>
      apiFetch(
        ...
        useGetApiV1SecurityFirewallConfigConfigVersionResponse,
        { method: "GET" },
      ),
    placeholderData: keepPreviousData,
  });

export const useGetApiV1SecurityFirewallConfigConfigVersion = (
  args: UseGetApiV1SecurityFirewallConfigConfigVersionArgs,
) => useQuery(getApiV1SecurityFirewallConfigConfigVersionQueryOptions(args));
