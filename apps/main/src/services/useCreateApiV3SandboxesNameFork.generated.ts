...
export type UseCreateApiV3SandboxesNameForkArgs = {
  name: string;
...
export const useCreateApiV3SandboxesNameForkResponse = z.object({
  sandbox: namedSandbox,
  session: session,
  routes: z.array(sandboxPublicRoute),
});

export type UseCreateApiV3SandboxesNameForkResponse = {
  sandbox: NamedSandbox;
  session: Session;
  routes: Array<SandboxPublicRoute>;
};

export type CreateApiV3SandboxesNameForkBody = {
  networkPolicy?:
    | (
        | {
            mode: "allow-all" | "deny-all" | "custom" | "default-allow" | "default-deny";
...
export const useCreateApiV3SandboxesNameFork = (
  options: UseMutationOptions<
    UseCreateApiV3SandboxesNameForkResponse,
    Error,
    UseCreateApiV3SandboxesNameForkArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UseCreateApiV3SandboxesNameForkArgs) =>
      apiFetch(
        buildUrl("/v3/sandboxes/{name}/fork", {
          name: args.name,
