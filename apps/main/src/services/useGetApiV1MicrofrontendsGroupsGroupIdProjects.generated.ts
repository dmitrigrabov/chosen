...
export const useGetApiV1MicrofrontendsGroupsGroupIdProjectsResponse = z.object({
  projects: z.array(
    z.object({
      accountId: z.string(),
      creator: z
...
export type UseGetApiV1MicrofrontendsGroupsGroupIdProjectsArgs = {
  groupId: string;
  teamId?: string | undefined;
  slug?: string | undefined;
};

export const getApiV1MicrofrontendsGroupsGroupIdProjectsQueryOptions = (
  args: UseGetApiV1MicrofrontendsGroupsGroupIdProjectsArgs,
) =>
  queryOptions({
    queryKey: [
    ...
    queryFn: () =>
      apiFetch(
        buildUrl("/v1/microfrontends/groups/{groupId}/projects", {
          groupId: args.groupId,
          teamId: args.teamId,
          slug: args.slug,
        }),
        useGetApiV1MicrofrontendsGroupsGroupIdProjectsResponse,
        { method: "GET" },
      ),
    placeholderData: keepPreviousData,
  });

export const useGetApiV1MicrofrontendsGroupsGroupIdProjects = (
  args: UseGetApiV1MicrofrontendsGroupsGroupIdProjectsArgs,
) => useQuery(getApiV1MicrofrontendsGroupsGroupIdProjectsQueryOptions(args));
