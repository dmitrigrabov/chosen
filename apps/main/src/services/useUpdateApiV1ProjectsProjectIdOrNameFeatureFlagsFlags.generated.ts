...
export type UseUpdateApiV1ProjectsProjectIdOrNameFeatureFlagsFlagsArgs = {
...
export const useUpdateApiV1ProjectsProjectIdOrNameFeatureFlagsFlagsResponse = z.object({
...
export type UseUpdateApiV1ProjectsProjectIdOrNameFeatureFlagsFlagsResponse = {
  description?: string | undefined;
...
export type UpdateApiV1ProjectsProjectIdOrNameFeatureFlagsFlagsBody = {
  slug: string;
  kind: "boolean" | "string" | "number" | "json";
  variants?:
    | Array<{
...
export const useUpdateApiV1ProjectsProjectIdOrNameFeatureFlagsFlags = (
  options: UseMutationOptions<
    UseUpdateApiV1ProjectsProjectIdOrNameFeatureFlagsFlagsResponse,
    Error,
    UseUpdateApiV1ProjectsProjectIdOrNameFeatureFlagsFlagsArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UseUpdateApiV1ProjectsProjectIdOrNameFeatureFlagsFlagsArgs) =>
      apiFetch(
