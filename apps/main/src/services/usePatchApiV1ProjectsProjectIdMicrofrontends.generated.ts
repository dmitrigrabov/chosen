...
export type UsePatchApiV1ProjectsProjectIdMicrofrontendsArgs = {
  projectId: string;
...
export const usePatchApiV1ProjectsProjectIdMicrofrontendsResponse = z.object({
  accountId: z.string(),
  creator: z
    .union([
      z.object({
...
export type UsePatchApiV1ProjectsProjectIdMicrofrontendsResponse = {
  accountId: string;
  creator?:
    | (
        | {
...
export type PatchApiV1ProjectsProjectIdMicrofrontendsBody = {
  microfrontendsGroupId?: string | undefined;
  enabled?: boolean | undefined;
  isDefaultApp?: boolean | undefined;
  defaultRoute?: string | undefined;
...
export const usePatchApiV1ProjectsProjectIdMicrofrontends = (
  options: UseMutationOptions<
    UsePatchApiV1ProjectsProjectIdMicrofrontendsResponse,
    Error,
    UsePatchApiV1ProjectsProjectIdMicrofrontendsArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UsePatchApiV1ProjectsProjectIdMicrofrontendsArgs) =>
      apiFetch(
        buildUrl("/v1/projects/{projectId}/microfrontends", {
