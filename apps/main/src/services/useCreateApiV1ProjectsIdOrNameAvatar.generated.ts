...
export type UseCreateApiV1ProjectsIdOrNameAvatarArgs = {
  idOrName: string;
  teamId?: string | undefined;
  slug?: string | undefined;
};

export const useCreateApiV1ProjectsIdOrNameAvatarResponse = z.object({
  accountId: z.string(),
  creator: z
    .union([
      z.object({
...
export type UseCreateApiV1ProjectsIdOrNameAvatarResponse = {
  accountId: string;
  creator?:
    | (
        | {
...
export type CreateApiV1ProjectsIdOrNameAvatarBody = void;

export const useCreateApiV1ProjectsIdOrNameAvatar = (
  options: UseMutationOptions<
    UseCreateApiV1ProjectsIdOrNameAvatarResponse,
    Error,
    UseCreateApiV1ProjectsIdOrNameAvatarArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UseCreateApiV1ProjectsIdOrNameAvatarArgs) =>
      apiFetch(
        buildUrl("/v1/projects/{idOrName}/avatar", {
