...
export type UsePatchApiV1ProjectsProjectIdRoutesRouteIdArgs = {
  projectId: string;
  routeId: string;
...
export const usePatchApiV1ProjectsProjectIdRoutesRouteIdResponse = z.object({
  route: z
    .object({
...
export type UsePatchApiV1ProjectsProjectIdRoutesRouteIdResponse = {
  route?:
    | {
...
export type PatchApiV1ProjectsProjectIdRoutesRouteIdBody = {
  route?:
    | {
        name: string;
        description?: string | undefined;
...
export const usePatchApiV1ProjectsProjectIdRoutesRouteId = (
  options: UseMutationOptions<
    UsePatchApiV1ProjectsProjectIdRoutesRouteIdResponse,
    Error,
    UsePatchApiV1ProjectsProjectIdRoutesRouteIdArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UsePatchApiV1ProjectsProjectIdRoutesRouteIdArgs) =>
      apiFetch(
        buildUrl("/v1/projects/{projectId}/routes/{routeId}", {
