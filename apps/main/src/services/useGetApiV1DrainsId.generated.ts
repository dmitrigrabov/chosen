...
export type UseGetApiV1DrainsIdArgs = {
  id: string;
  teamId?: string | undefined;
  slug?: string | undefined;
};

export const useGetApiV1DrainsIdResponse = z.union([
  z.object({
    id: z.string(),
    createdAt: z.number(),
    updatedAt: z.number(),
...
export const getApiV1DrainsIdQueryOptions = (args: UseGetApiV1DrainsIdArgs) =>
  queryOptions({
    queryKey: ["GET /v1/drains/{id}", "drains", args.id, args.teamId, args.slug],
    queryFn: () =>
      apiFetch(
        buildUrl("/v1/drains/{id}", { id: args.id, teamId: args.teamId, slug: args.slug }),
        useGetApiV1DrainsIdResponse,
        { method: "GET" },
      ),
  });

export const useGetApiV1DrainsId = (args: UseGetApiV1DrainsIdArgs) =>
  useQuery(getApiV1DrainsIdQueryOptions(args));
