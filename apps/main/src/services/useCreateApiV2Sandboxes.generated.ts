...
export type UseCreateApiV2SandboxesArgs = {
...
export const useCreateApiV2SandboxesResponse = z.object({
  sandbox: namedSandbox,
  session: session,
  routes: z.array(sandboxPublicRoute),
});

export type UseCreateApiV2SandboxesResponse = {
  sandbox: NamedSandbox;
  session: Session;
  routes: Array<SandboxPublicRoute>;
};

export type CreateApiV2SandboxesBody = {
  networkPolicy?:
    | (
        | {
            mode: "allow-all" | "deny-all" | "custom" | "default-allow" | "default-deny";
...
export const useCreateApiV2Sandboxes = (
  options: UseMutationOptions<
    UseCreateApiV2SandboxesResponse,
    Error,
    UseCreateApiV2SandboxesArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UseCreateApiV2SandboxesArgs) =>
      apiFetch(
        buildUrl("/v2/sandboxes", { teamId: args.teamId, slug: args.slug }),
        useCreateApiV2SandboxesResponse,
        {
          method: "POST",
