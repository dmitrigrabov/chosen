...
export type UseCreateApiV1KmsIssuersArgs = {
...
export const useCreateApiV1KmsIssuersResponse = z.object({
  id: z.string(),
  ownerId: z.string(),
  name: z.string(),
  algorithm: z.enum([
...
export type UseCreateApiV1KmsIssuersResponse = {
  id: string;
  ownerId: string;
  name: string;
  algorithm:
...
export type CreateApiV1KmsIssuersBody = {
  name: string;
  algorithm?:
    | (
        | "RS256"
...
export const useCreateApiV1KmsIssuers = (
  options: UseMutationOptions<
    UseCreateApiV1KmsIssuersResponse,
    Error,
    UseCreateApiV1KmsIssuersArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UseCreateApiV1KmsIssuersArgs) =>
      apiFetch(
        buildUrl("/v1/kms/issuers", { teamId: args.teamId, slug: args.slug }),
        useCreateApiV1KmsIssuersResponse,
        {
          method: "POST",
