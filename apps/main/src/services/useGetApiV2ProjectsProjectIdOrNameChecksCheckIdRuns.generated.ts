...
export const useGetApiV2ProjectsProjectIdOrNameChecksCheckIdRunsResponse = z.object({
  runs: z.array(
    z.union([
      z.object({
        id: z.string(),
...
export type UseGetApiV2ProjectsProjectIdOrNameChecksCheckIdRunsArgs = {
...
export const getApiV2ProjectsProjectIdOrNameChecksCheckIdRunsQueryOptions = (
  args: UseGetApiV2ProjectsProjectIdOrNameChecksCheckIdRunsArgs,
) =>
  queryOptions({
    queryKey: [
    ...
    queryFn: () =>
      apiFetch(
        buildUrl("/v2/projects/{projectIdOrName}/checks/{checkId}/runs", {
          projectIdOrName: args.projectIdOrName,
          checkId: args.checkId,
          teamId: args.teamId,
          slug: args.slug,
        }),
        useGetApiV2ProjectsProjectIdOrNameChecksCheckIdRunsResponse,
        { method: "GET" },
      ),
    placeholderData: keepPreviousData,
  });

export const useGetApiV2ProjectsProjectIdOrNameChecksCheckIdRuns = (
  args: UseGetApiV2ProjectsProjectIdOrNameChecksCheckIdRunsArgs,
) => useQuery(getApiV2ProjectsProjectIdOrNameChecksCheckIdRunsQueryOptions(args));
