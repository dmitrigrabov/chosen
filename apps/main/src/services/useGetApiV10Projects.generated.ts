...
export type UseGetApiV10ProjectsArgs = {
...
export const useGetApiV10ProjectsResponse = z
  .union([
    z.array(
      z.object({
        accountId: z.string(),
          ...
          z.object({
            ...
            deployment: z
              .object({
                ...
                branchMatcher: z
                  .object({
                    type: z.enum(["endsWith", "equals", "startsWith"]),
                    pattern: z.string(),
                  })
                  .optional(),
              ...
              .array(
                z.object({
                  src: z
                    ...
                    .optional(),
                  tierRequirement: z.enum(["advanced", "critical"]).optional(),
                  has: z
                    .array(
                      z.object({
                        type: z.enum([
                  ...
                  transforms: z
                    .array(
                      z.object({
                        type: z.literal("request.headers"),
                        op: z.literal("append"),
                        target: z.object({ key: z.string() }),
                        args: z.string(),
                      }),
                    )
                    .optional(),
    ...
    z.object({
              ...
              deployment: z
                .object({
                  ...
                  builds: z
                    ...
                    .optional(),
                  checksConclusion: z
                    .enum(["canceled", "failed", "skipped", "succeeded"])
                    .optional(),
                  checksState: z.enum(["completed", "registered", "running"]).optional(),
                  connectBuildsEnabled: z.boolean().optional(),
                  connectConfigurationId: z.string().optional(),
      ...
      pagination: z.union([
        z.object({ count: z.number(), next: z.string().nullable() }),
        pagination,
      ]),
    }),
    z.object({
      projects: z.array(
        z.object({
          ...
          protectionConfig: z
            .object({
              sandboxUrls: z
                .object({ inheritDeploymentProtection: z.boolean().optional() })
                .optional(),
            })
            .optional(),
          sandbox: z
...
export const getApiV10ProjectsQueryOptions = (args: UseGetApiV10ProjectsArgs) =>
  queryOptions({
    queryKey: [
      "GET /v10/projects",
      "projects",
      args.from,
      args.gitForkProtection,
      args.limit,
      args.search,
      args.repo,
      args.repoId,
      ...
      args.excludeRepos,
      args.edgeConfigId,
      args.edgeConfigTokenId,
      args.deprecated,
      args.elasticConcurrencyEnabled,
      args.staticIpsEnabled,
      args.buildMachineTypes,
      args.buildQueueConfiguration,
      args.teamId,
      args.slug,
    ],
    queryFn: () =>
      apiFetch(
        buildUrl("/v10/projects", {
          from: args.from,
          gitForkProtection: args.gitForkProtection,
          limit: args.limit,
          search: args.search,
          repo: args.repo,
          repoId: args.repoId,
          repoUrl: args.repoUrl,
          excludeRepos: args.excludeRepos,
          edgeConfigId: args.edgeConfigId,
          edgeConfigTokenId: args.edgeConfigTokenId,
          deprecated: args.deprecated,
          elasticConcurrencyEnabled: args.elasticConcurrencyEnabled,
          staticIpsEnabled: args.staticIpsEnabled,
          buildMachineTypes: args.buildMachineTypes,
          buildQueueConfiguration: args.buildQueueConfiguration,
          teamId: args.teamId,
          slug: args.slug,
        }),
        useGetApiV10ProjectsResponse,
        { method: "GET" },
      ),
  });

export const useGetApiV10Projects = (args: UseGetApiV10ProjectsArgs) =>
  useQuery(getApiV10ProjectsQueryOptions(args));
