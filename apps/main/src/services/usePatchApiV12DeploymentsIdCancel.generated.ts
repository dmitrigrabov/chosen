...
export type UsePatchApiV12DeploymentsIdCancelArgs = {
  id: string;
  teamId?: string | undefined;
  slug?: string | undefined;
};

export const usePatchApiV12DeploymentsIdCancelResponse = z.object({
  ...
  gitSource: z
    .union([
      ...
      z.object({ type: z.literal("custom"), ref: z.string(), sha: z.string(), gitUrl: z.string() }),
      z.object({
        type: z.literal("github"),
        ref: z.string(),
        sha: z.string(),
  ...
  config: z
    .object({
      ...
      functionMemoryType: z.enum(["performance", "performance_xl", "standard", "standard_legacy"]),
      ...
      resourceConfig: z
        .object({
          buildQueue: z
            ...
            .optional(),
          elasticConcurrency: z.enum(["PROJECT_SETTING", "SKIP_QUEUE", "TEAM_SETTING"]).optional(),
          buildMachine: z
            .object({
              purchaseType: z
  ...
  attribution: z
    .object({
      ...
      gitUser: z
        ...
        .optional(),
      vercelUser: z
        .object({ id: z.string(), username: z.string(), teamRoles: z.array(z.string()).optional() })
        .optional(),
    })
    .optional(),
});

export type UsePatchApiV12DeploymentsIdCancelResponse = {
...
export type PatchApiV12DeploymentsIdCancelBody = void;

export const usePatchApiV12DeploymentsIdCancel = (
  options: UseMutationOptions<
    UsePatchApiV12DeploymentsIdCancelResponse,
    Error,
    UsePatchApiV12DeploymentsIdCancelArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UsePatchApiV12DeploymentsIdCancelArgs) =>
      apiFetch(
        buildUrl("/v12/deployments/{id}/cancel", {
          id: args.id,
          teamId: args.teamId,
          slug: args.slug,
        }),
