...
export type UsePatchApiV9ProjectsIdOrNameArgs = {
  idOrName: string;
...
export const usePatchApiV9ProjectsIdOrNameResponse = z.object({
  accountId: z.string(),
  creator: z
    .union([
      z.object({
...
export type UsePatchApiV9ProjectsIdOrNameResponse = {
  accountId: string;
  creator?:
    | (
        | {
...
export type PatchApiV9ProjectsIdOrNameBody = {
  autoExposeSystemEnvs?: boolean | undefined;
  autoAssignCustomDomains?: boolean | undefined;
  autoAssignCustomDomainsUpdatedBy?: string | undefined;
  buildCommand?: (string | null) | undefined;
...
export const usePatchApiV9ProjectsIdOrName = (
  options: UseMutationOptions<
    UsePatchApiV9ProjectsIdOrNameResponse,
    Error,
    UsePatchApiV9ProjectsIdOrNameArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UsePatchApiV9ProjectsIdOrNameArgs) =>
      apiFetch(
