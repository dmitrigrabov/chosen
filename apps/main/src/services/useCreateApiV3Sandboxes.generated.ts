...
export type UseCreateApiV3SandboxesArgs = {
...
export const useCreateApiV3SandboxesResponse = z.object({
  sandbox: namedSandbox,
  session: session,
  routes: z.array(sandboxPublicRoute),
});

export type UseCreateApiV3SandboxesResponse = {
  sandbox: NamedSandbox;
  session: Session;
  routes: Array<SandboxPublicRoute>;
};

export type CreateApiV3SandboxesBody = {
  networkPolicy?:
    | (
        | {
            mode: "allow-all" | "deny-all" | "custom" | "default-allow" | "default-deny";
...
export const useCreateApiV3Sandboxes = (
  options: UseMutationOptions<
    UseCreateApiV3SandboxesResponse,
    Error,
    UseCreateApiV3SandboxesArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UseCreateApiV3SandboxesArgs) =>
      apiFetch(
        buildUrl("/v3/sandboxes", { teamId: args.teamId, slug: args.slug }),
        useCreateApiV3SandboxesResponse,
        {
          method: "POST",
