...
export const useGetApiV1WebhooksIdResponse = z.object({
...
export type UseGetApiV1WebhooksIdArgs = {
  id: string;
  teamId?: string | undefined;
  slug?: string | undefined;
};

export const getApiV1WebhooksIdQueryOptions = (args: UseGetApiV1WebhooksIdArgs) =>
  queryOptions({
    queryKey: ["GET /v1/webhooks/{id}", "webhooks", args.id, args.teamId, args.slug],
    queryFn: () =>
      apiFetch(
        buildUrl("/v1/webhooks/{id}", { id: args.id, teamId: args.teamId, slug: args.slug }),
        useGetApiV1WebhooksIdResponse,
        { method: "GET" },
      ),
    placeholderData: keepPreviousData,
  });

export const useGetApiV1WebhooksId = (args: UseGetApiV1WebhooksIdArgs) =>
  useQuery(getApiV1WebhooksIdQueryOptions(args));
