...
export type UseUpdateApiV1ProjectsProjectIdOrNameFeatureFlagsSegmentsArgs = {
...
export const useUpdateApiV1ProjectsProjectIdOrNameFeatureFlagsSegmentsResponse = z.object({
...
export type UseUpdateApiV1ProjectsProjectIdOrNameFeatureFlagsSegmentsResponse = {
  description?: string | undefined;
  createdBy?: string | undefined;
...
export type UpdateApiV1ProjectsProjectIdOrNameFeatureFlagsSegmentsBody = {
  slug: string;
  createdBy?: string | undefined;
  label: string;
  description?: string | undefined;
...
export const useUpdateApiV1ProjectsProjectIdOrNameFeatureFlagsSegments = (
  options: UseMutationOptions<
    UseUpdateApiV1ProjectsProjectIdOrNameFeatureFlagsSegmentsResponse,
    Error,
    UseUpdateApiV1ProjectsProjectIdOrNameFeatureFlagsSegmentsArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UseUpdateApiV1ProjectsProjectIdOrNameFeatureFlagsSegmentsArgs) =>
      apiFetch(
