...
export type UsePatchApiV9ProjectsIdOrNameCustomEnvironmentsEnvironmentSlugOrIdArgs = {
  idOrName: string;
...
export const usePatchApiV9ProjectsIdOrNameCustomEnvironmentsEnvironmentSlugOrIdResponse = z.object({
  id: z.string(),
  slug: z.string(),
...
export type UsePatchApiV9ProjectsIdOrNameCustomEnvironmentsEnvironmentSlugOrIdResponse = {
  id: string;
  slug: string;
...
export type PatchApiV9ProjectsIdOrNameCustomEnvironmentsEnvironmentSlugOrIdBody = {
  slug?: string | undefined;
  description?: string | undefined;
  branchMatcher?:
    | ({ type: "equals" | "startsWith" | "endsWith"; pattern: string } | null)
...
export const usePatchApiV9ProjectsIdOrNameCustomEnvironmentsEnvironmentSlugOrId = (
  options: UseMutationOptions<
    UsePatchApiV9ProjectsIdOrNameCustomEnvironmentsEnvironmentSlugOrIdResponse,
    Error,
    UsePatchApiV9ProjectsIdOrNameCustomEnvironmentsEnvironmentSlugOrIdArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UsePatchApiV9ProjectsIdOrNameCustomEnvironmentsEnvironmentSlugOrIdArgs) =>
      apiFetch(
