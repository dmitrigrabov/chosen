...
export type UsePatchApiV2ProjectsProjectIdOrNameChecksCheckIdArgs = {
...
export const usePatchApiV2ProjectsProjectIdOrNameChecksCheckIdResponse = z.object({
  id: z.string(),
  name: z.string(),
  ownerId: z.string(),
  projectId: z.string(),
...
export type UsePatchApiV2ProjectsProjectIdOrNameChecksCheckIdResponse = {
  id: string;
  name: string;
  ownerId: string;
  projectId: string;
...
export type PatchApiV2ProjectsProjectIdOrNameChecksCheckIdBody = {
  name?: string | undefined;
  isRerequestable?: boolean | undefined;
  requires?: ("build-ready" | "deployment-url") | undefined;
  targets?: Array<string> | undefined;
...
export const usePatchApiV2ProjectsProjectIdOrNameChecksCheckId = (
  options: UseMutationOptions<
    UsePatchApiV2ProjectsProjectIdOrNameChecksCheckIdResponse,
    Error,
    UsePatchApiV2ProjectsProjectIdOrNameChecksCheckIdArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UsePatchApiV2ProjectsProjectIdOrNameChecksCheckIdArgs) =>
      apiFetch(
