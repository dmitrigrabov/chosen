...
export type UsePatchApiV1DrainsIdArgs = {
  id: string;
...
export const usePatchApiV1DrainsIdResponse = z.union([
  z.object({
    id: z.string(),
    createdAt: z.number(),
    updatedAt: z.number(),
...
export type UsePatchApiV1DrainsIdResponse =
  | {
      id: string;
      createdAt: number;
      updatedAt: number;
...
export type PatchApiV1DrainsIdBody = {
  name?: string | undefined;
  projects?: ("some" | "all") | undefined;
  projectIds?: (Array<string> | null) | undefined;
  filter?:
...
export const usePatchApiV1DrainsId = (
  options: UseMutationOptions<
    UsePatchApiV1DrainsIdResponse,
    Error,
    UsePatchApiV1DrainsIdArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UsePatchApiV1DrainsIdArgs) =>
      apiFetch(
